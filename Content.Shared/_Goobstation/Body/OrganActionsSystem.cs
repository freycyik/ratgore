...
public sealed class OrganActionsSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<OrganActionsComponent, OrganAddedToBodyEvent>(OnAdded);
        ...
        SubscribeLocalEvent<OrganActionsComponent, OrganRemovedFromBodyEvent>(OnRemoved);
    }
    ...
    private void OnAdded(Entity<OrganActionsComponent> ent, ref OrganAddedToBodyEvent args)
    {
    ...
    private void OnRemoved(Entity<OrganActionsComponent> ent, ref OrganRemovedFromBodyEvent args)
    {
