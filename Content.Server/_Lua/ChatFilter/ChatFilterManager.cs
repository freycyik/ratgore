...
public sealed class ChatFilterManager
{
    ...
    private void LogAndNotify(EntityUid source, string message)
    {
        ...
        { audioSystem.PlayGlobal(new SoundPathSpecifier("/Audio/Effects/Cargo/ping.ogg"), Filter.Empty().AddPlayers(_adminManager.ActiveAdmins), false, AudioParams.Default.WithVolume(5f)); }
    }
