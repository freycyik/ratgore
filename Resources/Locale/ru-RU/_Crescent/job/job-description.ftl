...
job-description-ncwl-partisan = Защищай Лигу. Слушай своего офицера флота. Делай, что приказано.
...
# syndicate
job-description-ringleader = Координируй КВСТ. Утверждай и обеспечивай исполнение контрактов.
job-description-lieutenant = Помогай своему Главярю координировать КВСТ. Утверждай и обеспечивай исполнение контрактов.
...
job-description-coordinator = Координируй Интердайн. Веди учёт запасов. Следи, чтобы контракты выполнялись.
...
job-description-foreman = Координируй Профсоюз. Веди пиратские абордажи. Разбирай суда на лом.

# empire
job-description-freeholder = Обеспечивай доход и ресурсы для Империи.
job-description-levyman = Защищай владения и исполняй волю Кайзера.
job-description-knight = Возглавляй и организуй Имперский флот.
job-description-ritter = Облачись в экзопанцирь. Неси победу и славу Империи в бою.
job-description-courtier = Используй интриги и влияние, чтобы укреплять свою власть и повышать статус.
job-description-labor =  Управляй промышленностью и торговлей.
job-description-adjutant = Координируй действия Империи, обеспечивая выполнение приказов и эффективное управление.
job-description-governor = Защищай свои территории любой ценой. Твой главный долг — сохранить Мандат и обеспечить его процветание.
job-description-logistics = Отвечай за снабжение армии кораблями и боеприпасами.
job-description-wealth = Управляй экономикой. Обеспечивай финансовый поток Империи и отвечай за выплаты.
job-description-foremanimp = Руководи рабочими, обеспечивая эффективность и дисциплину.
job-description-scribe = Исследуй новые технологии, поднимай и восстанавливай заброшенные суда для усиления флота.
job-description-archmaester = Возглавляй технологов. Открывай и внедряй передовые технологии.
job-description-surgeon = Лечи раны и болезни своих товарищей по оружию, сохраняя боеспособность армии.
job-description-advocatus = Расследуй дела и проверяй лояльность подданных Империи. Допрашивай преступников, карай изменников и следи за соблюдением Мандата.
...
# cmm
job-description-ordnanceman = Обслуживай артиллерию судов минитменов. Заведуй арсеналом.
...
job-description-marshal = Координируй минитменов. Надзирай за военным и гражданским судом. Защищай систему.
...
job-description-tinkerer = Присматривай за вечно хворающим Аасимом. Следи, чтобы всё работало. Исследуй новые технологии.
job-description-hangartech = Присматривай за лавкой Тхаккер, перемещай грузы, следи за трюмом Аасим.
job-description-techminer = Ходи за ломом. Ищи артефакты и утраченную технологию для Мастеров.
job-description-beltrunner = Доставляй продукцию Издари с Аасим нужным людям. Обеспечивай безопасность операций своей семьи.
