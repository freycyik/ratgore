...
namespace Content.Client.Options.UI.Tabs
{
    ...
    public sealed partial class AudioTab : Control
    {
        ...
        public AudioTab()
        {
            ...
            TTSSoundsCheckBox.Pressed = _cfg.GetCVar(CCVars.TTSSoundsEnabled); // Art-TTS
        ...
        private void OnApplyButtonPressed(BaseButton.ButtonEventArgs args)
        {
            ...
            _cfg.SetCVar(CCVars.TTSSoundsEnabled, TTSSoundsCheckBox.Pressed); // Art-TTS
            _cfg.SaveToFile();
            UpdateChanges();
        }
